...
Como usuario farmaceutico, quiero poder contactarme con algún especialista en el programa y sus
funciones para qué pueda resolver mis dudas y dificultades durante el uso.Scenario:

    #----------------------------------------------------------------------------------------
    Scenario: Información de contacto

        Given el usuario farmaceutico tiene dudas y/o problemas qué no se logran respuesta/solución
        en la app con la información dada
